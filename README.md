# FabCRM
Sistema CRM desenvolvido por mim em fase de construção. (toda ajuda é bem vinda!).
...
2.  **Importar o Esquema e Dados:**
    ...
    *   Importe o arquivo `teste2.sql`. Este arquivo contém a estrutura de todas as tabelas e dados iniciais, incluindo o usuário administrador.
