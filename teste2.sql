...
INSERT INTO `estoque_movimentacao` (`id`, `mercadoria_id`, `tipo`, `quantidade`, `observacao`, `user_id`, `created_at`) VALUES
(2, 10, 'entrada', 1, 'ATUALIZAÇÃO 1 APARELHO', 1, '2025-11-28 15:05:50'),
(3, 10, 'saida', 2, 'ATUALIZAÇÃO 2 APARELHO SAIU', 1, '2025-11-28 15:06:23');
...
INSERT INTO `mercadorias` (`id`, `sku`, `nome`, `valor_unitario`, `categoria_id`, `quantidade_estoque`, `localizacao_estoque`, `estoque_minimo`, `created_at`) VALUES
(10, '0001', 'MANTHUS START', NULL, 4, 8, NULL, 0, '2025-11-28 15:05:20');
...
(1, 'Admin', 'fabiano@fabiano.com.br', '$2y$10$4Ar1lGW6OXaNNtBVY7qlMOVGd6f680.JNIlOmm8R4F/IxNUOCP9TG', 'admin', 'uploads/avatars/2_1764348587.png');
